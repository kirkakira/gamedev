                ...
                <div class="card glass-effect hover-grow">
                    ...
                    <div class="card-body">
                        ...
                        <?= $form->field($model, 'description')->textarea([
                            'rows' => 4,
                            'placeholder' => 'Опишите назначение форума...'
                        ]) ?>

                        <div class="form-group mt-5 d-flex justify-content-between">
                            <?= Html::a('<i class="bi bi-arrow-left me-2"></i> Отмена', ['index'], [
                                'class' => 'btn btn-outline-secondary glass-effect'
                            ]) ?>
                            <?= Html::submitButton('<i class="bi bi-save me-2"></i> Создать форум', [
